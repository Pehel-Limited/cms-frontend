...
export default function EditProductPage() {
  ...
  const [formData, setFormData] = useState<Partial<UpdateProductRequest>>({});
    ...
    const loadProduct = async () => {
      try {
        ...
        setFormData({
          ...
          interestLogicDescription: product.interestLogicDescription,
          principalStructure: product.principalStructure,
          regulatoryBody: product.regulatoryBody,
          eligibleCustomerTypes: product.eligibleCustomerTypes || ['INDIVIDUAL', 'BUSINESS'],
          minCustomerAge: product.minCustomerAge,
          maxCustomerAge: product.maxCustomerAge,
          minCreditScore: product.minCreditScore,
          minAnnualIncome: product.minAnnualIncome,
          minYearsInBusiness: product.minYearsInBusiness,
          minBusinessRevenue: product.minBusinessRevenue,
          minLoanAmount: product.minLoanAmount,
          maxLoanAmount: product.maxLoanAmount,
          defaultLoanAmount: product.defaultLoanAmount,
          amountStepSize: product.amountStepSize,
          ...
          prepaymentPenaltyPercentage: product.prepaymentPenaltyPercentage,
          collateralRequired: product.collateralRequired,
          loanToValueRatio: product.loanToValueRatio,
          downPaymentRequired: product.downPaymentRequired,
          minDownPaymentPercentage: product.minDownPaymentPercentage,
          requiresGuarantor: product.requiresGuarantor,
          minGuarantors: product.minGuarantors,
          isFeatured: product.isFeatured,
          isOnlineApplicationEnabled: product.isOnlineApplicationEnabled,
          autoApprovalEnabled: product.autoApprovalEnabled,
          autoApprovalMaxAmount: product.autoApprovalMaxAmount,
          autoApprovalMinCreditScore: product.autoApprovalMinCreditScore,
  ...
  const handleCategoryChange = (category: string) => {
    ...
    setFormData(prev => ({
      ...
      productType: productTypes[0]?.value || prev.productType,
    }));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSaving(true);
      await productService.updateProduct(productId, formData as UpdateProductRequest);
          ...
          <div className="flex justify-between items-center h-16">
            <div>
              ...
              <p className="text-xs text-gray-600 mt-0.5">
                {originalProduct?.productName} ({originalProduct?.productCode})
              </p>
            </div>
            <Link
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={3}
                      placeholder="e.g., Equal monthly installments, Balloon payment at end..."
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                    />
                  </div>
